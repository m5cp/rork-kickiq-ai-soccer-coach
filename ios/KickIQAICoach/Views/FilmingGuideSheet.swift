...
struct FilmingGuideSheet: View {
        ...
        VStack(alignment: .leading, spacing: KickIQAICoachTheme.Spacing.sm) {
            ...
            VStack(spacing: KickIQAICoachTheme.Spacing.sm) {
                ForEach(clipTypes, id: \.text) { clip in
                    HStack(alignment: .top, spacing: KickIQAICoachTheme.Spacing.sm + 2) {
        ...
        HStack(alignment: .top, spacing: KickIQAICoachTheme.Spacing.md) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text(guideline.subtitle)
                    ...
                    .foregroundStyle(KickIQAICoachTheme.accent.opacity(0.8))
    ...
    private var commonMistakes: some View {
        ...
        .padding(KickIQAICoachTheme.Spacing.md)
        .background(Color.red.opacity(0.06), in: .rect(cornerRadius: KickIQAICoachTheme.Radius.lg))
        .overlay(
