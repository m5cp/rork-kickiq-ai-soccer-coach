...
class ConditioningDrillsService {
    ...
    private func generateConditioningDrills(level: SkillLevel) -> [Drill] {
        ...
        drills.append(contentsOf: [
            ...
            Drill(name: "Standard Strength Circuit", description: "Two rounds of push-pull-leg pattern. Each round: Push-Ups 12 reps, Chin-Ups 12 reps, Walking Lunges 12 each leg, Shoulder Press 12 reps, Dumbbell Rows 12 reps, Step-Up Knee to Chest 12 each leg. Repeat. Finish with 5 core exercises 20 reps each.", duration: "35 min", difficulty: .intermediate, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Full range of motion every rep", "No momentum — controlled movement", "Rest 15-30 seconds between exercises"], reps: "2 full rounds"),
            Drill(name: "Explosive Strength Circuit", description: "Two rounds of explosive push-pull-leg pattern. Curl to Shoulder Press 12, Pull-Up Knee to Chest 12, Box Jumps 12, Explosive Push-Ups with Clap 12, Dumbbell Rows 12, Diagonal Lunges 12 each leg. Repeat. Finish with 5 core exercises 20 reps each.", duration: "35 min", difficulty: .advanced, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Explosive on every power movement", "Control the landing on jumps", "Maintain form even when fatigued"], reps: "2 full rounds"),
            Drill(name: "12 Station Circuit", description: "30 seconds work and 30 seconds rest per station. Complete twice through all 12 stations. Stations: Shoulder Press, Cross-Country Skier Jump, Crunches, T-Shape Agility Run, Chin-Up with Twist, Hip Lifts, Dot Drill Fast Footwork, Toe Touches, Explosive Push-Up with Clap, Walking Diagonal Lunge, Dumbbell Rows, Double Bicycle Kicks.", duration: "25 min", difficulty: .intermediate, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Work hard for the full 30 seconds", "Rest fully during the rest period", "Complete the second round even when tired"], reps: "2 full circuits — 24 stations total"),
            Drill(name: "Parallel Squat Holds", description: "Stand with feet shoulder-width apart. Lower into a parallel squat position pausing at the bottom of each rep. Use good form with knee over foot.", duration: "10 min", difficulty: .beginner, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Knee over foot throughout", "Pause at the bottom", "Drive through heels to stand"], reps: "3 sets of 20"),
            Drill(name: "Single-Leg Lunge Series", description: "Three lunge variations for unilateral leg strength. Forward single-leg lunge, lateral side lunge, and scissors lunge. Builds the strength needed for shooting, jumping, and change of direction.", duration: "12 min", difficulty: .intermediate, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Knee tracks over middle toe", "Full range of motion each rep", "Control the lowering phase"], reps: "20-30 reps each variation"),
            Drill(name: "Kneeling Hamstring Fall", description: "Kneel on the ground with a partner or anchor holding your ankles. Slowly lower your body forward using hamstrings to control the descent. Push back up with hands only if needed. Critical injury prevention exercise for soccer players.", duration: "10 min", difficulty: .advanced, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Control the lowering phase — go slow", "Keep hips fully extended throughout", "Use hands to push back only if needed"], reps: "3 sets of 6"),
            Drill(name: "Progressive Leg Strength Workout", description: "Squats, lunges, power lunges, wall sits, and calf raises with volume that increases over a 16-week program. Each phase adds sets and reps.", duration: "30 min", difficulty: .intermediate, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Knee aligned over toes on squats", "Full depth on all lunges", "Wall sit: hips at 90 degrees"], reps: "Phase 1 Weeks 1-4: Squats 3x10, Lunges 3x8 per leg, Power Lunges 30 alternating, Wall Sit 3x1 min, Calf Raises 2x30"),
            Drill(name: "Upper Body Strength Workout", description: "Push-pull upper body workout combining chest, back, and shoulder exercises. Push-ups, chin-ups, dips, and dumbbell movements for soccer-specific upper body strength.", duration: "25 min", difficulty: .intermediate, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Control the lowering phase", "Full lock-out at top of push movements", "Neutral spine throughout"], reps: "3-5 sets of 10-20 reps depending on program phase"),
            Drill(name: "Core Endurance Progression", description: "Progressive core workout increasing in volume across a 16-week program. Crunches, V-Sit Side to Side, Bicycle Kicks, Toe Touches, Hip Lifts, Superman Hold, and Plank holds.", duration: "15 min", difficulty: .beginner, targetSkill: ConditioningFocus.strength.rawValue, coachingCues: ["Control through full range of motion", "No momentum on crunches", "Steady breathing throughout"], reps: "Phase 1: 30 crunches, 2 min plank. Builds to Phase 4: 100 crunches, 8x3 min plank")
        ])
