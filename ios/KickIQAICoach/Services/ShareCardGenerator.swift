    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(spacing: 14) {
                ...
                Rectangle()
                    .fill(LinearGradient(colors: [KickIQAICoachTheme.accent, KickIQAICoachTheme.accent.opacity(0)], startPoint: .leading, endPoint: .trailing))
                    .frame(height: 1.5)
                        ...
                        HStack(spacing: 8) {
                            ...
                            ZStack(alignment: .leading) {
                                ...
                                Capsule()
                                    .fill(
                                        LinearGradient(
                                            colors: [KickIQAICoachTheme.accent.opacity(0.6), KickIQAICoachTheme.accent],
                                            startPoint: .leading,
                                            endPoint: .trailing
                                        )
                                    )
            ...
            .padding(.vertical, 8)
            .background(KickIQAICoachTheme.accent)
        }
        .frame(width: 320)
        ...
        VStack(spacing: 0) {
            VStack(spacing: 16) {
                ...
                if improvement > 0 {
                    ...
                    Text("I've improved \(improvement) points in \(weeks) week\(weeks == 1 ? "" : "s") with KickIQAICoach")
        ...
        VStack(spacing: 3) {
            HStack(spacing: 3) {
                ...
                Text(value)
                    ...
                    .foregroundStyle(accent ? KickIQAICoachTheme.accent : .white)
            }
            Text(label)
        ...
        VStack(spacing: 0) {
            VStack(spacing: 16) {
                ...
                ZStack {
                    ...
                    Circle()
                        .fill(KickIQAICoachTheme.accent.opacity(0.05))
