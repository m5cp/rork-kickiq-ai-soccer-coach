    ...
    private func drillsForSkill(_ skill: SkillCategory, level: SkillLevel) -> [Drill] {
        ...
        case .firstTouch:
            return [
                ...
                Drill(name: "1 Touch Wall Pass at 3 Yards", description: "Stand 3 yards from a wall and pass the ball along the ground using 1 touch whenever possible. Mostly inside of feet. Wall returns the ball for continuous reps.", duration: "8 min", difficulty: .beginner, targetSkill: skill.rawValue, coachingCues: ["Soft touch on each pass", "Alternate feet where possible", "Keep the ball on the ground"], reps: "50 passes"),
                Drill(name: "2 Touch Wall Pass at 5 Yards", description: "Stand 5 yards from wall. Control the return with your first touch then pass back with your second touch. Mostly inside of feet.", duration: "8 min", difficulty: .beginner, targetSkill: skill.rawValue, coachingCues: ["First touch out of your feet", "Quick second touch pass", "Stay on your toes"], reps: "25 passes"),
                Drill(name: "1 Touch Wall Pass at 5 Yards", description: "Same as 3-yard drill but from 5 yards. The ball comes back faster requiring quicker reactions and sharper touch.", duration: "8 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Get body behind the ball early", "Cushion on contact", "Immediate return pass"], reps: "50 passes"),
                Drill(name: "Weak Foot Wall Pass at 5 Yards", description: "Stand 5 yards from wall. Every pass must be made with your non-preferred foot. Receiving foot can be either — but every pass back must be weak foot.", duration: "8 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Lock ankle on weak foot pass", "Commit fully to the technique", "Accuracy over power"], reps: "25 passes"),
                Drill(name: "1 Touch Wall Pass at 10 Yards", description: "Stand 10 yards from wall. Pass with 1 touch. Ball returns faster requiring sharper reactions and cleaner first touch.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Early body positioning before ball arrives", "Soft cushioned touch", "Return pass with weight and accuracy"], reps: "50 passes"),
                Drill(name: "2 Touch Wall Pass at 10 Yards", description: "Stand 10 yards from wall. Control the return then pass back in 2 touches.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["First touch sets up the pass", "Second touch is the pass", "Stay balanced throughout"], reps: "25 passes"),
                Drill(name: "Weak Foot Wall Pass at 10 Yards", description: "Same as weak foot drill at 5 yards but from 10 yards. Passing with non-preferred foot at greater distance.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Strike through the center of the ball", "Follow through toward the wall", "Build confidence with each rep"], reps: "25 passes"),
                Drill(name: "Alternating Foot Wall Pass at 10 Yards", description: "Stand 10 yards from wall. Must alternate receiving and passing foot on every touch. A sweep touch is required to redirect.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Commit to alternating feet every rep", "Sweep touch for the redirect", "Build a smooth rhythm"], reps: "25 passes"),
                Drill(name: "Move In and Out Wall Drill", description: "Start 10 yards from wall. Pass with 1 touch and take a step closer after each pass until you can touch the wall. Reverse — step back with each pass until 10 yards away.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Adjust touch weight as distance changes", "Stay balanced at each position", "One full in-and-out cycle counts as 1 rep"], reps: "3 complete cycles"),
                Drill(name: "1 Touch Wall Pass at 20 Yards", description: "Stand 20 yards from wall. Pass with 1 touch. Some instep striking required to reach the wall. Receiving the powerful return cleanly is the key challenge.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Strike with instep for distance", "Get body behind the ball on return", "First touch sets up your next action"], reps: "25 passes"),
                Drill(name: "Loft and Control at 25 Yards", description: "Stand 25 yards from wall. Drive ball off wall hitting it 5 to 8 feet from the ground on the fly. Receive the return cleanly and repeat. Alternate feet.", duration: "12 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Drive with instep for height and distance", "Watch ball all the way down", "Settle cleanly before next pass"], reps: "15 passes"),
                Drill(name: "Track It Down Drill", description: "Stand 8 yards from wall. Toss ball high off wall so it returns overhead. Sprint after it, control it, turn, then strike against wall and receive again.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Sprint immediately after the toss", "Control before you turn", "Clean strike to restart the sequence"], reps: "15 tosses"),
                Drill(name: "Chest Trap and Pass Wall Drill", description: "Stand 10 yards from wall. Toss ball so it returns at chest level. Chest trap to receive, control to feet, then pass against wall and receive again.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Cushion with chest on contact", "Drop ball to feet cleanly", "Quick pass after control"], reps: "15 tosses"),
                Drill(name: "Turn Left and Return", description: "Stand 10 yards from wall with 2 cones placed diagonally behind you 20 yards away. Play ball off wall along the ground. Receive rebound and make a 120-degree turn to the left. Dribble around cone and return to start.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Receive with a soft touch", "Commit to the turn direction", "Accelerate away from the wall after the turn"], reps: "10 turns"),
                Drill(name: "Turn Right and Return", description: "Same as Turn Left drill except turn to the right after receiving from the wall.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Turn sharply to the right", "Ball stays close through the turn", "Sprint back to starting position"], reps: "10 turns"),
                Drill(name: "1 Touch and Spin Wall Drill", description: "Stand 10 yards from wall. Pass with 1 touch then immediately spin 360 degrees. Be ready to receive the return after the spin. Alternate spin direction each rep.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Quick full spin", "Locate the ball as you come out of the spin", "Immediate touch on return"], reps: "20 passes")
            ]
        case .bodyPosition:
            return [
        ...
        case .ballControl:
            return [
                ...
                Drill(name: "Change of Pace Dribble", description: "Dribble slowly forward 10 yards with both feet then increase to maximum speed for 10 more yards using the instep with step-touch technique. Stop ball at 20 yards.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Deliberate slow phase first", "Explosive acceleration to full speed", "Push ball with instep at full pace"], reps: "5 times"),
                Drill(name: "Box Dribble Drill", description: "Dribble around the outside of a 5x5 yard box using rollovers and dragbacks on each side of the box.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Sharp corners — don't drift wide", "Ball stays close throughout", "Increase speed each lap"], reps: "4 times around"),
                Drill(name: "Figure 8 Cone Dribble", description: "Dribble in a figure 8 pattern around 2 cones 5 yards apart. Complete with either foot then isolate right and left foot separately.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Tight turns around each cone", "Accelerate between cones", "Use inside and outside of foot"], reps: "4 times — 2 with either foot, 1 right only, 1 left only"),
                Drill(name: "Cone Slalom Dribble", description: "Place 5 cones in a line 3 yards apart. Dribble in slalom to the top of the line and back.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Sharp cuts not wide arcs", "Ball stays close through each gate", "Accelerate on the straights"], reps: "4 times"),
                Drill(name: "Staircase Cone Dribble", description: "Lay out 6 cones in a staircase pattern 5 yards apart up and across. Dribble around cones following the staircase pattern.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Plan the route ahead of the ball", "Quick direction changes at each cone", "Ball always within playing distance"], reps: "4 times"),
                Drill(name: "15 Yard Loop Drill", description: "Place 4 cones in a line 5 yards apart. Dribble around the 3rd cone, back around the 2nd cone, and finish at the 4th cone.", duration: "10 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Commit to the loop path", "Accelerate out of each turn", "Stay in control through the full pattern"], reps: "4 times"),
                Drill(name: "180 Turn Dribble Drill", description: "Dribble 5 yards then make a sharp 180-degree turn. Dribble 5 yards back and repeat the turn. Complete 6 total turns all with the same foot then switch.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Sharp turn — don't drift wide", "Accelerate immediately after the turn", "Use inside hook or pullback turn"], reps: "1 set each foot"),
                Drill(name: "Start-Stop Dribble Drill", description: "Dribble forward 10 yards then perform a sudden stop using the sole. Continue forward 10 yards and stop again. Alternate the stopping foot each rep.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Clean stop with sole of foot", "Immediate restart after each stop", "Simulates evading a press"], reps: "3 stops each direction"),
                Drill(name: "Sprint Dribble and Stop", description: "Sprint-dribble to a marker 25 yards away, stop the ball cleanly, sprint back to start, sprint forward to the ball, collect it and sprint-dribble back to start.", duration: "12 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Full sprint on every phase", "Clean stop at the marker", "Collect the ball smoothly on return"], reps: "3 times")
            ]
        case .shooting:
            return [
                ...
                Drill(name: "Shooting Technique Wall Drill", description: "Stand 10 to 12 yards from a solid wall. Strike the ball ensuring toe is pointed down, knee over ball, center of instep strikes center of ball, all power from quick snapping lower leg motion.", duration: "10 min", difficulty: .beginner, targetSkill: skill.rawValue, coachingCues: ["Toe down — lock the ankle", "Knee over the ball", "Quick snap of lower leg through the ball"], reps: "30 strikes"),
                Drill(name: "First-Time Power Shooting", description: "Stand 20 yards from wall. Strike ball as hard as possible regardless of how it returns — any height, any pace, any angle. Pick a spot on the wall and keep ball low.", duration: "10 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["Read the return early", "Commit to the shot every time", "Keep ball low on the wall"], reps: "30 shots"),
                Drill(name: "Trap and Shoot Wall Drill", description: "From 20 yards, strike the wall, trap the return cleanly, and fire another shot immediately. A sound clean trap followed by a quick hard shot is the goal.", duration: "12 min", difficulty: .intermediate, targetSkill: skill.rawValue, coachingCues: ["First touch sets up the shot", "Shoot within 2 touches", "Trap cleanly even when tired"], reps: "30 reps"),
                Drill(name: "Target Striking Drill", description: "Mark a 2x2 yard target on a wall with chalk. Stand 20 yards away and drive ball against wall using 2 touches each time. Track hits vs misses. Goal is 3 consecutive hits before 4 misses.", duration: "12 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Pick your spot before striking", "Strike through the center of the ball", "Accuracy over power"], reps: "10 attempts per round"),
                Drill(name: "Wall Pass and Redirect Shooting", description: "Place 3 cones — 2 outer cones 20 yards apart and 12 yards from wall, 1 middle cone 5 yards from wall. Dribble from an outer cone toward wall, execute a wall pass around the middle cone, dribble to and around the outer cone. Repeat opposite direction.", duration: "12 min", difficulty: .advanced, targetSkill: skill.rawValue, coachingCues: ["Time the wall pass precisely", "Dribble at pace not flat out", "Finish each rep cleanly around the cone"], reps: "8 wall passes each direction")
            ]
        case .movement:
            return [
